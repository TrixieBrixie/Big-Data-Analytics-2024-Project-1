...
with concurrent.futures.ThreadPoolExecutor(max_workers=n) as executor:
    ...
    # Combine the two lists of futures
    futures = futures1 + futures2
    # Wait for each future to complete and get the result as to ensure that all threads finish their tasks
