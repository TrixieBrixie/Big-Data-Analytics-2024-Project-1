...
def parallel_runner1():
    ...
    p2.start() # Starts the process p2
    p3.start() # Starts the process p3

    p1.join() # Waits for the process p1 to complete
    p2.join() # Waits for the process p2 to complete
    p3.join() # Waits for the process p3 to complete
